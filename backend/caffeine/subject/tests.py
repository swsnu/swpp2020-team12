...
class SubjectTestCase(TestCase):
    def setUp(self):  # beforeeach 같은거
        ...
        Subject1=Subject.objects.create(name='team1', description ='this is description1',
                                        time=datetime.timedelta(hours=10, minutes=42), user=user1)
        Subject2=Subject.objects.create(name='team2', description ='this is description2',
                                        time=datetime.timedelta(hours=15, minutes=20), user=user2)
        Subject3 = Subject.objects.create(name='team3', description='this is description3',
